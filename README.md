[![Run App SimreenKaur](https://github.com/simreenkaur/GithubActions/actions/workflows/run-app.yaml/badge.svg?branch=master)](https://github.com/simreenkaur/GithubActions/actions/workflows/run-app.yaml)
